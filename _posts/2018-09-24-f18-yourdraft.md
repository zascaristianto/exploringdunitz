...
To add an image you will use an exclamation point, then a description in brackets, and then the location of the image in parentheses. We will try to store ALL of our images in the GitHub repository.  There is also a little bit of text after the image in the special curly brackets and the word image inside it. Leave this alone! It displays the image in a special viewer so when you click on the image it opens it up in its own viewer and then you can cycle through all the images in this viewer. You can put in as many images as you like. Just always make sure to have the curly brackets afterwards.
   ...
   ![Provisional Google Street Image](images/provisional1.jpg)
   {:.image}
This is a Google Street image. This image was found in [Google Street Map](https://www.google.com/maps/@33.9996122,-118.2918727,3a,37.5y,29.92h,90.19t/data=!3m6!1e1!3m4!1sD5hOTsqmVfpFEWRVdXEXVA!2e0!7i16384!8i8192)
   {:.caption} 
